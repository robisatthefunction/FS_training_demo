...
function onActivate(activateObject) {
  console.log(dimColor, `DEBUG: [${activateObject.variation.key}] User "${activateObject.userId}" has been bucketed in ${activateObject.variation.key}`);
}

let activateId = optimizelyClientInstance.notificationCenter.addNotificationListener(
